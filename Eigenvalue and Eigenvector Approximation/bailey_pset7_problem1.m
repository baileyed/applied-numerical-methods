...
%Open an output file.
OutputFile = fopen('bailey_pset7_problem1.txt','w');

%Print title to the screen and to the output file.
fprintf('\n OUTPUT FROM bailey_pset7_problem1.m \n\n');
fprintf(OutputFile, '\n OUTPUT FROM bailey_pset7_problem1.m \n\n');
...
fprintf(' Finding Eigenvectors and Eigenvalues Using Power Method \n');
fprintf(OutputFile, ' Finding Eigenvectors and Eigenvalues Using Power Method \n');
...
if check < epsilon
    fprintf(' Eigenvalue we seek, found in %2d iterations, is lambda = %+1.5e with corresponding eigenvector x(k)', k, lambda);
    fprintf(OutputFile, ' Eigenvalue we seek, found in %2d iterations, is lambda = %+1.5e with corresponding eigenvector x(k)', k, lambda);
